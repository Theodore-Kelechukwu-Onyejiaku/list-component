...
const ClientServices = ({ each }) => {
  return <li className="list-group-item" style={{"backgroundColor":"rgb(197, 21, 21)", "color": "white"}}>{each}</li>;
};
  ...
  return (
    <div className="App text-danger container">
      <div className="heading text-center">
        ...
        <img  src={genie} className="img-fluid" style={{"max-width": "100%","height": "auto" }}/>
      </div>
      <div className="row mt-3">
        <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4">
          <ul className="list-group" style={{"border": "3px rgb(197, 21, 21) solid"}}>
